        ...
        */
        ...
        public function generate_data()
        {
        	...
        	$_POST =	array (
        			...
        			'_wp_http_referer' => '/wp-admin/users.php?page=export-user-data',
        			'usermeta' =>
        			array (
        					0 => 'nickname',
        					1 => 'first_name',
        					...
        					3 => '_subscribe',
        					4 => 'shipping_company',
        					5 => 'shipping_address_1',
        					6 => 'shipping_address_2',
        					7 => 'shipping_city',
        					8 => 'shipping_postcode',
        					9 => 'shipping_country',
        					10 => 'shipping_last_name',
        					11 => 'shipping_first_name',
        					12 => 'billing_email',
        					13 => 'billing_first_name',
          ...
          //          header( 'Content-Disposition: attachment; filename='.$filename.'.csv' );
            //        header( 'Content-Type: text/csv; charset=' . get_option( 'blog_charset' ), true );
                ...
                case ( 'excel' ):
                    ...
                    include( '../../../../plugins/export-user-data/xml-template.php' );
            ...
            // echo headers ##
            $line	= $pre . implode( $seperator, $headers ) . $breaker;
            ...
            foreach ( $users as $user ) {
                ...
                // echo row data ##
                $line	.=	 $pre . implode( $seperator, $data ) . $breaker;
